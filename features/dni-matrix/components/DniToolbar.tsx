        ...
        {showExportMenu && (
          <div className={`export-dropdown-menu ${openUpwards ? 'open-up' : 'open-down'}`}>
            ...
            <div className="export-menu-items">
              ...
              {/* Opción Excel: Exportar Datos a Excel (.xlsx) */}
              <button
                type="button"
                className="export-menu-item opt-excel"
                disabled={isExporting}
                onClick={() => {
                  setShowExportMenu(false);
                  handleExportExcel();
                }}
                title="Descargar tabla Excel con 2 columnas: Nombres y Apellidos + DNI"
              >
                ...
                <div className="export-item-text">
                  <div className="export-item-title">Exportar Datos a Excel (.xlsx)</div>
                  <div className="export-item-desc">2 columnas: Nombres y Apellidos + DNI</div>
                </div>
              </button>
