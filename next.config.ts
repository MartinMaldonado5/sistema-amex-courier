  ...
  async rewrites() {
    return {
      ...
      afterFiles: [
        ...
        { source: '/directorio-clientes', destination: '/' },
        { source: '/directorio', destination: '/' },
        { source: '/clientes-360', destination: '/' },
        { source: '/clientes360', destination: '/' },
        { source: '/clientes', destination: '/' },
        { source: '/crm-clientes', destination: '/' },
